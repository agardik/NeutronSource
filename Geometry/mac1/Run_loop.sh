...
/testhadr/det/readFile CenteredSphere${drift}.gdml
...
/gps/direction 0 0 -1
#
/analysis/setFileName /media/sf_vm-share/Neutron source output/Centered_Sphere_RAd/Centered_Sphere_${drift}
